...
open class ParsingTaskDelegate(private val parsingTasks : List<org.hugoandrade.downloader.parsing.tasks.ParsingTask>) :
    org.hugoandrade.downloader.parsing.tasks.ParsingTask {
    ...
    override fun parseMediaFile(doc: Document): ParsingData? {
        ...
        var selectedTask : org.hugoandrade.downloader.parsing.tasks.ParsingTask? = null
